      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-3 md:inset-4 lg:inset-6 z-50 flex flex-col bg-white dark:bg-dark-card rounded-2xl shadow-2xl overflow-hidden"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Top bar */}
            <div className="flex items-center justify-between px-4 md:px-6 py-3 border-b border-gray-100 dark:border-gray-800 bg-gray-50/80 dark:bg-dark-surface/80 backdrop-blur-sm flex-shrink-0">
