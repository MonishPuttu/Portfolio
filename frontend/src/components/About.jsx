...
const About = () => {
  ...
  const skills = [
    ...
    { name: 'Prototyping', level: 88, color: 'from-fuchsia-500 to-fuchsia-600' },
    { name: 'User Research', level: 85, color: 'from-violet-500 to-violet-600' },
  ];

  const values = [
    { icon: Heart, title: 'User-Centered', description: 'Every design decision is driven by user needs and insights' },
    { icon: Sparkles, title: 'Innovation', description: 'Pushing boundaries to create unique digital experiences' },
    { icon: Users, title: 'Collaboration', description: 'Working closely with teams to bring visions to life' },
    { icon: Zap, title: 'Impact', description: 'Creating solutions that make a real difference' },
  ];

  const tools = ['Figma', 'Sketch', 'Adobe XD', 'Photoshop', 'Illustrator', 'After Effects', 'Principle', 'Framer'];

  return (
    <section id="about" className="py-20 lg:py-28 px-6 lg:px-8 bg-white dark:bg-[#0a0a0a]">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-20">
            ...
            <div className="space-y-10">
              ...
              >
                ...
                <div className="space-y-4 text-[15px] text-gray-600 dark:text-gray-400 leading-relaxed">
                  ...
                  <p>
                    ...
                    experiences that not only look great but also drive real business results.
                  </p>
                  <p>
                    When I'm not designing, you'll find me exploring the latest design trends, mentoring
                    aspiring designers, or working on personal projects that push the boundaries of
              ...
              >
                <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Skills & Expertise</h4>
            ...
            <div>
              ...
              >
                <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-6">What Drives Me</h4>
                  ...
                  {values.map((value, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <h5 className="text-sm font-bold text-gray-900 dark:text-white mb-1">{value.title}</h5>
              ...
              <motion.div
                ...
                className="mt-10"
              >
                <h4 className="text-lg font-bold text-gray-900 dark:text-white mb-5">Tools I Use</h4>
